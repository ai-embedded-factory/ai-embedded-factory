 ...
 * REQ: REQ-API-0094
 * API: mpx_mq_extendattr_getcontrolsize
 */

int main(void) {
  /* Description (extract): This pthreadsmore service returns the size of the internal message queue control structure. The primary purpose of this API is to inform the application how much memory is required for the mpx_mq_extendattr_setcontroladdr API. */
  ...
  if (mpx_skip_if_stubbed("mpx_mq_extendattr_getcontrolsize")) return 0;
