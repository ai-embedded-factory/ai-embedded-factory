 ...
 ******************************************************************************
   ...
   Section VIII: Middleware Support 
...
#define MPX_INTERNAL_FILE_CLOSE_ROUTINE_ERROR               2001UL
#define MPX_INTERNAL_FILE_READ_ROUTINE_ERROR                2002UL
#define MPX_INTERNAL_FILE_WRITE_ROUTINE_ERROR               2003UL
#define MPX_INTERNAL_HIGHEST_SET_BIT_GET_ID                 2004UL
#define MPX_INTERNAL_ISR_ENTER_ID                           2005UL
#define MPX_INTERNAL_ISR_EXIT_ID                            2006UL
#define MPX_INTERNAL_MEMORY_ALLOCATE_ID                     2007UL
#define MPX_INTERNAL_MEMORY_MANAGER_ALLOCATE_ID             2008UL
#define MPX_INTERNAL_MEMORY_MANAGER_RELEASE_ID              2009UL
#define MPX_INTERNAL_NET_CLOSE_ROUTINE_ERROR                2010UL
#define MPX_INTERNAL_NET_READ_ROUTINE_ERROR                 2011UL
#define MPX_INTERNAL_NET_WRITE_ROUTINE_ERROR                2012UL
#define MPX_INTERNAL_THREAD_ENTER_ID                        2013UL
#define MPX_INTERNAL_THREAD_EXIT_ID                         2014UL
#define MPX_INTERNAL_THREAD_PRIORITY_CHANGE_ID              2015UL
#define MPX_INTERNAL_THREAD_READY_ID                        2016UL
#define MPX_INTERNAL_THREAD_SUSPEND_ID                      2017UL
#define MPX_INTERNAL_THREAD_SWITCH_TO                       2018UL
#define MPX_INTERNAL_THREAD_SWITCH_FROM                     2019UL
#define MPX_INTERNAL_THREAD_TIMER_PROCESS_ID                2020UL 
#define MPX_INTERNAL_THREAD_WRAPPER_ID                      2021UL
#define MPX_INTERNAL_TICKTIMER_EXPIRE_ID                    2022UL
#define MPX_INTERNAL_TIME_SLICE_PROCESS_ID                  2023UL
#define MPX_INTERNAL_TIMER_ACTIVATE_ID                      2024UL
#define MPX_INTERNAL_TIMER_DEACTIVATE_ID                    2025UL
#define MPX_INTERNAL_TIMER_LIST_PROCESS_ID                  2026UL
#define MPX_INTERNAL_CLEANUP_HANDLERS_EXECUTE_ID            2027UL
#define MPX_INTERNAL_THREAD_DEFERRED_MEMORY_RELEASE_ID      2028UL
...
#ifndef MEMCPY
#define MEMCPY(destination, source, bytes_to_copy)          mpx_internal_memcpy(destination, source, bytes_to_copy);
#endif  /* MEMCPY */
...
#ifndef MEMSET
#define MEMSET(destination, value, bytes_to_set)            mpx_internal_memset(destination, value, bytes_to_set);
#endif  /* MEMSET */
...
/* Default the MPX timer interrupt pre-processing extension to white-space.  */
...
/* Default the MPX timer interrupt post-processing extension to white-space.  */
...
typedef struct mpx_thread_control_struct
{
    ...
    mpx_thread_links volatile                               ready_list;
...
typedef struct mpx_mutex_control_struct
{
    ...
    mpx_thread_control * volatile                           current_access;
...
typedef struct mpx_global_data_struct
{
    ...
    mpx_thread_control * volatile                           threads_current_access;
    ...
    mpx_thread_control * volatile                           condition_vars_current_access;
    ...
    mpx_thread_control * volatile                           event_flags_current_access;
    ...
    mpx_thread_control * volatile                           fastqueues_current_access;
    ...
    mpx_thread_control * volatile                           memorypools_current_access;
    ...
    mpx_thread_control volatile *                           mutexes_current_access;
    ...
    mpx_thread_control * volatile                           partitionpools_current_access;
    ...
    mpx_thread_control * volatile                           queues_current_access;
    ...
    mpx_thread_control * volatile                           semaphores_current_access;
    ...
    mpx_thread_control * volatile                           ticktimers_current_access;
...
void            mpx_internal_thread_ready(mpx_thread_control *  thread_pointer, mpx_thread_control **  volatile suspension_list_head, u_long * volatile suspended_count);
void            mpx_internal_thread_suspend(mpx_thread_control *  thread_pointer, int  suspended_state, mpx_thread_control ** volatile suspension_list_head, u_long * volatile suspended_count);
...
void            mpx_internal_memcpy(void *  destination, void *  source, size_t  bytes_to_copy);
void            mpx_internal_memset(void *  destination, int  value, size_t  bytes_to_set);
...
#define close                                               mpx_rtos_close_dispatch
#define read                                                mpx_rtos_read_dispatch
#define write                                               mpx_rtos_write_dispatch


/* Define the starting MPX FILE base handle value.  */

#ifndef MPX_FILE_HANDLE_BASE
#define MPX_FILE_HANDLE_BASE                                8192
#endif  /* MPX_FILE_HANDLE_BASE */

void           mpx_rtos_file_close_register(int  (* close_routine)(int handle));
void           mpx_rtos_file_read_register(ssize_t  (* read_routine)(int handle, void *  buffer, size_t  bytes_to_read));
void           mpx_rtos_file_write_register(ssize_t  (* write_routine)(int handle, void *  buffer, size_t  bytes_to_write));
void           mpx_rtos_net_close_register(int  (* close_routine)(int handle));
void           mpx_rtos_net_read_register(ssize_t  (* read_routine)(int handle, void *  buffer, size_t  bytes_to_read));
void           mpx_rtos_net_write_register(ssize_t  (* write_routine)(int handle, void *  buffer, size_t  bytest_to_write));
int            mpx_rtos_close_dispatch(int  handle);
ssize_t        mpx_rtos_read_dispatch(int  handle, void *  buffer, size_t  bytes_to_read);
ssize_t        mpx_rtos_write_dispatch(int  handle, void *  buffer, size_t  bytes_to_write);
