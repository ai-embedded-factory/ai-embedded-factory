 ...
 * REQ: REQ-API-0121
 * API: mpx_semattr_setname
 */

int main(void) {
  /* Description (extract): This pthreadsmore service sets the semaphore name in the specified attribute structure. */
  ...
  if (mpx_skip_if_stubbed("mpx_semattr_setname")) return 0;
